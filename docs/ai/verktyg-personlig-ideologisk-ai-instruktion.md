...
| Axel | −10 | +10 |
|-----|-----|-----|
| Ekonomi | Stat | Marknad |
| Frihet | Libertariansk | Auktoritär |
| Kultur | Progressiv | Konservativ |

Sätt värdet utifrån ideologins **kärnprinciper** och skriv en **kort motivering under skalan**.
